    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Image
            source={{ uri: "https://i.pravatar.cc/100?u=bot" }}
      ...
      >
        ...
        >
          ...
          <View style={styles.warningBanner}>
            <View style={styles.warningIcon}>
              <Ionicons name="flash-off" size={18} color="#D32F2F" />
            </View>
            <Text style={styles.warningText}>
              هذا المساعد للإرشاد القانوني الأولي. في الحالات العاجلة، يرجى
              استشارة محامٍ معتمد.
            </Text>
          </View>
          ...
          <View style={styles.botBubble}>
            <Text style={styles.botText}>
              أهلاً بك. أنا مساعدك القانوني المدعوم بالذكاء الاصطناعي. كيف
              يمكنني مساعدتك في استشارتك القانونية اليوم؟
            </Text>
            <Text
              style={[styles.botText, { marginTop: 15, fontWeight: "700" }]}
            >
              يمكنني مساعدتك في:
            </Text>
            <Text style={styles.listItem}>• مراجعة العقود والاتفاقيات</Text>
            <Text style={styles.listItem}>
              • توضيح الأنظمة واللوائح السعودية
            </Text>
          ...
          <View style={styles.userBubble}>
            <Text style={styles.userText}>
              أريد الاستفسار عن حقوق الموظف في حالة إنهاء العقد غير المشروع
              وفقاً لنظام العمل السعودي الجديد.
            </Text>
          </View>
          <Text
            style={[styles.timestamp, { textAlign: "left", marginLeft: 15 }]}
          >
            10:32 ص
          </Text>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerNote}>
            الأمان والخصوصية: يتم تشفير جميع المحادثات قانونياً
          </Text>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
