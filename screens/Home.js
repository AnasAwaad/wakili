      ...
      >
          ...
          >
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroSubtitle}>
                وكيلي هو دليلك الأمثل لأفضل الخبرات القانونية في المملكة.
                استشارات دقيقة وسرعة في الأداء وخصوصية تامة لجميع قضاياك.
              </Text>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.stepCard}>
            <View
              style={[styles.stepIconCircle, { backgroundColor: "#E8EDF5" }]}
            >
              <Ionicons name="person-add" size={24} color="#0A2353" />
            </View>
            <Text style={styles.stepTitle}>سجل معنا</Text>
            <Text style={styles.stepDesc}>
              أنشئ حسابك الخاص كطالب خدمة وباشر برحلة قانونية في بيئة آمنة
              ومتطورة.
            </Text>
          </View>
          ...
          <View style={styles.stepCard}>
            <View
              style={[styles.stepIconCircle, { backgroundColor: "#FEF4D9" }]}
            >
              <Ionicons name="search" size={24} color="#C49B3B" />
            </View>
            <Text style={styles.stepTitle}>ابحث عن محامٍ</Text>
            <Text style={styles.stepDesc}>
              استخدم محرك البحث الخاص لتصفية المحامين حسب التخصص، الموقع والقيم
              الأخلاقية.
            </Text>
          </View>
          ...
          <View style={styles.stepCard}>
            <View
              style={[styles.stepIconCircle, { backgroundColor: "#0A2353" }]}
            >
              <Ionicons name="calendar" size={24} color="#FFF" />
            </View>
            <Text style={styles.stepTitle}>احجز جلسة</Text>
            <Text style={styles.stepDesc}>
              اختر الموعد الأنسب لجدولك الزمني واستعد لتجربة فريدة من المشورة أو
              عبر الاتصال الذكي.
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.sectionContainer, styles.reviewsSection]}>
          ...
          <Text style={styles.reviewsSubLabel}>
            نفتخر بخدمة آلاف العملاء ومساهمتنا في تسهيل شؤونهم القانونية عبر
            منصة وكيلي المتطورة.
          </Text>
          ...
          <View style={styles.reviewCard}>
            <View style={styles.starsRow}>
              {[1, 2, 3, 4, 5].map((i) => (
                <Ionicons key={i} name="star" size={14} color="#C49B3B" />
              ))}
            </View>
            <Text style={styles.reviewText}>
              "تجربة استثنائية جداً! تمكنت من العثور على محامٍ متخصص في إعادة
              التجديد العقاري في أقل من دقيقتين. الخدمة كانت رائعة وسهولة التصفح
              مميزة."
            </Text>
            <View style={styles.reviewerInfo}>
              ...
              <Image
                source={{ uri: "https://i.pravatar.cc/100?u=khaled" }}
          ...
          <View style={styles.reviewCard}>
            ...
            <Text style={styles.reviewText}>
              "وكيلي سهل لي الكثير من الجهد، وكان استشاري قانوني متخصصاً
              ومهنياً. المنصة توفر سهولة في اختيار المحامي الذي تفضله."
            </Text>
            <View style={styles.reviewerInfo}>
              <View style={styles.reviewerText}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerAbout}>
            المنصة القانونية الأكثر ثقة في الشرق الأوسط، نسعى لتمكين الأفراد
            والشركات من الوصول لأفضل الاستشارات القانونية والموثوقة بسرعة وأمان.
          </Text>
          ...
          <Text style={styles.newsletterDesc}>
            انضم لقائمتنا البريدية للحصول على آخر التحديثات.
          </Text>
          ...
          <Text style={styles.copyright}>
            جميع الحقوق محفوظة لمنصة وكيلي ٢٠٢٤
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
