      ...
      <View style={styles.header}>
        <View style={styles.profileBox}>
          <TouchableOpacity onPress={() => router.push("/(tabs)/profile")}>
            <Image
              source={{ uri: "https://i.pravatar.cc/100?u=admin" }}
      ...
      >
            ...
            <View style={styles.lawyerDetails}>
              ...
              <View style={styles.tagRow}>
                <View style={styles.tag}>
                  <Text style={styles.tagText}>{lawyer.title}</Text>
                </View>
              ...
              <View style={styles.ratingRow}>
                <View style={styles.stars}>
                  {[1, 2, 3, 4, 5].map((i) => (
                    <Ionicons key={i} name="star" size={12} color="#C49B3B" />
                  ))}
                </View>
                <Text style={styles.ratingValue}>
                  {lawyer.rating} ({lawyer.reviews} تقييم)
                </Text>
              </View>
            </View>
        ...
        <View style={styles.aiBanner}>
          ...
          <Text style={styles.aiTitle}>
            هل تحتاج إلى استشارة قانونية عاجلة؟
          </Text>
          <Text style={styles.aiSubtitle}>
            تواصل مع مراجعنا القانوني الذكي.
          </Text>
