  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Image source={{ uri: 'https://i.pravatar.cc/100?u=user' }} style={styles.headerAvatar} />
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.stepperContainer}>
           <View style={styles.stepBox}>
              <View style={[styles.stepDot, styles.stepInactive]}><Text style={styles.stepNumInactive}>٣</Text></View>
              <Text style={styles.stepLabelInactive}>الدفع</Text>
           </View>
           <View style={styles.stepLine} />
           <View style={styles.stepBox}>
              <View style={[styles.stepDot, styles.stepInactive]}><Text style={styles.stepNumInactive}>٢</Text></View>
              <Text style={styles.stepLabelInactive}>التفاصيل</Text>
           </View>
           <View style={styles.stepLine} />
           <View style={styles.stepBox}>
              <View style={[styles.stepDot, styles.stepActive]}><Text style={styles.stepNumActive}>١</Text></View>
        ...
        <View style={styles.lawyerCard}>
           <Image 
            source={{ uri: 'https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&q=80&w=150' }} 
        ...
        <View style={styles.sectionWrap}>
           ...
           <TouchableOpacity 
             style={[styles.sessionBtn, sessionType === 'in-person' && styles.sessionActive]} 
             onPress={() => setSessionType('in-person')}
           >
              <MaterialCommunityIcons name="office-building" size={24} color={sessionType === 'in-person' ? "#0A2353" : "#AAA"} />
              <View style={styles.sessionBtnText}>
                 <Text style={styles.sessionTitle}>استشارة حضورية</Text>
                 <Text style={styles.sessionSubtitle}>مكتب وسط المدينة، البرج أ</Text>
              </View>
           ...
           <TouchableOpacity 
             style={[styles.sessionBtn, sessionType === 'phone' && styles.sessionActive]} 
             onPress={() => setSessionType('phone')}
           >
              <MaterialCommunityIcons name="phone-outline" size={24} color={sessionType === 'phone' ? "#0A2353" : "#AAA"} />
              <View style={styles.sessionBtnText}>
        ...
        <View style={styles.calendarCard}>
           <View style={styles.calendarHeader}>
              <TouchableOpacity><Ionicons name="chevron-back" size={20} color="#0A2353" /></TouchableOpacity>
              <Text style={styles.monthName}>أكتوبر ٢٠٢٣</Text>
              <TouchableOpacity><Ionicons name="chevron-forward" size={20} color="#0A2353" /></TouchableOpacity>
           </View>
              ...
              {days.map(d => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && <Text style={styles.selectedLabel}>مختار</Text>}
                  </TouchableOpacity>
                );
              })}
           </View>
        ...
        <View style={styles.timeSection}>
           ...
           <View style={styles.slotsGrid}>
              {slots.map(slot => (
                <TouchableOpacity 
                  key={slot.value} 
                  style={[styles.slotBtn, selectedSlot === slot.value && styles.slotSelected]}
                  onPress={() => setSelectedSlot(slot.value)}
                >
                  <Text style={[styles.slotBtnText, selectedSlot === slot.value && styles.slotBtnTextActive]}>
                    {slot.time}
                  </Text>
                </TouchableOpacity>
              ))}
