    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.uploadCard}>
          <View style={styles.uploadZone}>
            ...
            <Text style={styles.uploadSubtitle}>
              قم بسحب وإفلات ملف العقد (PDF) هنا لاستخراج الكيانات والبنود
              تلقائياً
            </Text>
        ...
        <View style={styles.sectionWrap}>
          <View style={styles.sectionHeader}>
            <View style={styles.activeBadge}>
              <Text style={styles.activeBadgeTxt}>نشط</Text>
            </View>
          ...
          >
            <View style={styles.statCard}>
              <View
                style={[styles.statIconBox, { backgroundColor: "#051128" }]}
              >
            ...
            <View style={styles.statCard}>
              ...
              >
                <Ionicons name="calendar" size={18} color="#F44336" />
              </View>
            ...
            <View style={styles.statCard}>
              <View
                style={[styles.statIconBox, { backgroundColor: "#FFF9C4" }]}
              >
                <Ionicons name="cash" size={18} color="#FBC02D" />
              </View>
            ...
            <View style={styles.statCard}>
              <View
                style={[styles.statIconBox, { backgroundColor: "#EDF0F5" }]}
              >
                <Ionicons name="location" size={18} color="#0A2353" />
              </View>
        ...
        <View style={styles.resultsContainer}>
          <View style={styles.tabsRow}>
            <TouchableOpacity
              style={[
                styles.tabBtn,
                activeTab === "spirits" && styles.tabActive,
              ]}
            ...
            >
              <Text
                style={[
                  styles.tabText,
                  activeTab === "spirits" && styles.tabTextActive,
                ]}
              >
                من روح الذكي
              </Text>
          ...
          <View style={styles.tabContent}>
            <View style={styles.analysisHeader}>
              ...
              <View style={{ alignItems: "flex-end" }}>
                ...
                <Text style={styles.resultSubtitle}>
                  تمت المراجعة بواسطة محرك وكيلي للذكاء الاصطناعي
                </Text>
              </View>
            </View>
            ...
            <View style={styles.summaryCard}>
              ...
              <Text style={styles.summaryText}>
                يتمثل هذا المستند في عقد توريد خدمات تقنية بين شركة "ألما"
                للحلول البرمجية ومؤسسة "بيتا" التجارية. العقد محدد المدة بسنة
                واحدة، ويتضمن بنوداً صارمة تتعلق بسرية البيانات والتعويضات في
                حال التأخير.
              </Text>
            </View>
            ...
            <View style={styles.metricCard}>
              <View style={styles.metricRow}>
                ...
                <Text style={[styles.metricStatus, { color: "#D32F2F" }]}>
                  منخفضة
                </Text>
              </View>
              <View style={styles.riskBar}>
                <View
                  style={[
                    styles.riskProgress,
                    { width: "80%", backgroundColor: "#D32F2F" },
                  ]}
                />
              </View>
            </View>
            ...
            <View style={[styles.gapCard, { borderRightColor: "#D32F2F" }]}>
              ...
              <View style={styles.gapInfo}>
                ...
                <Text style={styles.gapBody}>
                  البند 2.14 يفتقر إلى تعريف دقيق لحالات الطوارئ الصحية
                  العالمية.
                </Text>
              </View>
            </View>
            ...
            <View style={[styles.gapCard, { borderRightColor: "#0A2353" }]}>
              <View style={[styles.gapIconBox, { backgroundColor: "#F0F2F5" }]}>
                <Ionicons name="information-circle" size={18} color="#0A2353" />
              </View>
              <View style={styles.gapInfo}>
                <Text style={styles.gapHeading}>تجديد العقد تلقائياً</Text>
                <Text style={styles.gapBody}>
                  العقد يتجدد تلقائياً ما لم يتم الإخطار قبل 30 يوماً من
                  الانتهاء.
                </Text>
              </View>
            </View>
        ...
        <View style={styles.expertPromo}>
          <Image
            source={{ uri: "https://i.pravatar.cc/100?u=legal" }}
            style={styles.expertAvatar}
          />
          <Text style={styles.expertText}>
            يتوفر دعم قانوني مباشر لهذا المستند
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
