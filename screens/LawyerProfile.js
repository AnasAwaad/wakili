    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileHero}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&q=80&w=400' }}
            style={styles.profileCover}
          />
          <View style={styles.avatarMain}>
            <Image source={{ uri: 'https://i.pravatar.cc/200?u=lawyer1' }} style={styles.lawyerImg} />
        ...
        <View style={styles.infoBox}>
          ...
          <View style={styles.tagRow}>
            <View style={styles.tag}><Text style={styles.tagText}>قانون الشركات</Text></View>
            <View style={styles.tag}><Text style={styles.tagText}>التحكيم</Text></View>
          </View>
        ...
        <View style={styles.tabsLayout}>
          <TouchableOpacity style={[styles.tabBtn, styles.tabActive]}>
            <Text style={[styles.tabText, styles.tabTextActive]}>السيرة والخبرة</Text>
          </TouchableOpacity>
        ...
        <View style={styles.contentSection}>
          ...
          <View style={styles.timeline}>
            <View style={styles.timelineItem}>
              <View style={styles.timeIconBox}><Ionicons name="briefcase" size={14} color="#FFF" /></View>
              <View style={styles.timeCard}>
                <Text style={styles.timeYear}>2018 - الحاضر</Text>
                <Text style={styles.timeTitle}>شريك إداري أول</Text>
                <Text style={styles.timeBody}>الجمعي ومشاركوه - قسم الشركات. قيادة قضايا التفاوض المعقدة عبر الحدود.</Text>
              </View>
            </View>

            <View style={styles.timelineItem}>
              <View style={styles.timeIconBox}><Ionicons name="school" size={14} color="#FFF" /></View>
              <View style={styles.timeCard}>
                <Text style={styles.timeYear}>2012 - 2018</Text>
                <Text style={styles.timeTitle}>مستشار قانوني أول</Text>
                <Text style={styles.timeBody}>مجموعة الإمارات للاستثمار. الإشراف على الإطار القانوني الداخلي.</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.bookingContainer}>
          <View style={styles.bookingHeader}>
            ...
            <MaterialCommunityIcons name="calendar-clock" size={24} color="#0A2353" />
          </View>
          ...
          <View style={styles.calendarStrip}>
            <Text style={styles.monthLabel}>المواعيد المتاحة - أكتوبر ٢٠٢٤</Text>
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.daysScroll}>
              {[1, 2, 3, 4, 5, 6, 7].map(d => (
                <TouchableOpacity key={d} style={[styles.dayChip, d === 2 && styles.dayActive]}>
                  <Text style={[styles.dayNum, d === 2 && styles.dayNumActive]}>{d}</Text>
                  <Text style={[styles.dayName, d === 2 && styles.dayNameActive]}>الاثنين</Text>
                </TouchableOpacity>
              ))}
            </ScrollView>
          </View>
