...
export default function ClientProfile() {
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        {/* User Hero */}
        <LinearGradient colors={["#0A2353", "#051128"]} style={styles.userHero}>
          <View style={styles.profileBox}>
            <View style={styles.avatarWrapper}>
              <Image
                source={{ uri: "https://i.pravatar.cc/200?u=client1" }}
                style={styles.avatar}
              />
              <View style={styles.badge}>
                <Text style={styles.badgeTxt}>بريميوم</Text>
              </View>
            </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.filterRow}>
            <TouchableOpacity style={styles.filterBtn}>
              <Text style={styles.filterTxt}>جميع الحالات</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.filterBtn, styles.filterActive]}>
              <Text style={styles.filterActiveTxt}>آخر ٣٠ يوم</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.tableHeader}>
            ...
            <Text
              style={[styles.tableHead, { flex: 2.5, textAlign: "center" }]}
            >
              التاريخ والوقت
            </Text>
          </View>
